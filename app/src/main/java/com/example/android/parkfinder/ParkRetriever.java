...
public class ParkRetriever {
    ...
    public List<Park> getAllParks() {
        ...
        // TODO: Remove this.  Just testing scrolling performance
        //addLotsOfParks(parks);

        return parks;
    }

    private void addLotsOfParks(ArrayList<Park> parks){
        // TODO: Remove these.  Just testing lots of parks
        parks.add(getSouthRoseHillPark());
        parks.add(getNorthRoseHillPark());
        parks.add(getGrassLawnPark());
        parks.add(getPeterKirkPark());
